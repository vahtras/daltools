...
class TestSirRst(unittest.TestCase):
    ...
    def test_dets1(self):
        self.assertTupleEqual(list(self.sirifc.xindx())[0], ((0,), (0,)))

    def test_dets2(self):
        self.assertTupleEqual(list(self.sirifc.xindx())[3], ((1,), (1,)))

    def test_dets3(self):
        self.assertTupleEqual(list(self.sirifc3.xindx())[0], ((0, 1), ()))
